...
--batch-size 128 --data VOC_OCR_dep_bg.yaml --cfg yolov5m.yaml \
--weights '/home/bwz/project/ocr-gy/yolov5/yolov5/runs/train/ocr_5m_v/weights/best.pt' \
...
# nohup /home/bwz/project/ocr-gy/yolov5/train_dep.sh >nohup_5m_bg.out 2>&1 &
